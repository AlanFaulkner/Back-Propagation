...
public:
	...
	void Train_Network(std::vector<std::vector<double>>Training_Data, double Training_Rate = 0.5, double Target_Error = 0.000001, double Max_Iterations = 10000000);
	...
	std::vector<std::vector<double>> Calculate_Batch_Output(std::vector<std::vector<double>> Input_Data);
